    ...
    <div className="flex justify-center items-center gap-5">
      <div className="max-w-3xl w-full text-left leading-loose mb-20 mt-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-text-secondary">Expected Graduation: June 2027 GPA: 3.96/4.00</p>
          <p className="text-gray-700 leading-7">Studying B.S in Computer Science from the Maseeh College of Engineering.</p>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700 leading-7">Customer service - P.O.S Machine - Membership management</p>
          ...
          <p className="text-gray-700 leading-7">Fast-paced environment - Food handling - Customer service</p>
        </div>
