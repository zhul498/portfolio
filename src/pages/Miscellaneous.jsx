    ...
    return (
        <div className="flex justify-center items-center gap-5">
            <div className="max-w-3xl w-full text-left leading-loose">
                <p className="text-gray-700 leading-7 mb-4">Thanks for looking through my website!</p>

                <h1 className="text-2xl font-bold mb-4">Acknowledgements</h1>
                <p className="text-gray-700 leading-7"> Countless YouTube tutorials for React helped me create this website, along with the great looking timeline in the Projects
                ...
                <p className="text-gray-700 leading-7"> This layout was heavily inspired by{' '} <a href="https://www.aidanandrews.info" target="_blank" rel="noopener noreferrer" 
                ...
                <p className="text-gray-700 leading-7">This website is being hosted by DigitalOcean. You can learn more about them{' '}<a href="https://www.digitalocean.com/" 
