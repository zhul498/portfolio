    ...
    <div className="bg-white dark:bg-neutral-900 dark:text-white py-12 animate-fade-in">
      <div className="max-w-5xl mx-auto px-6">        
        <div className="space-y-8">
          <div>
            <h3 className="text-2xl font-bold text-neutral-900 dark:text-white">City of Hillsboro</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold text-neutral-900 dark:text-white">McDonald's</h3>
